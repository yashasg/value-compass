...
| `app/Sources/App` | Entry point, app lifecycle |
| `app/Sources/Features` | UI screens |
| `app/Sources/Backend/Networking` | SwiftOpenAPIGenerator output |
| `app/Sources/Backend/Models` | Swift data models |
