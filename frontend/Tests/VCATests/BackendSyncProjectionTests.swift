...
final class BackendSyncProjectionTests: XCTestCase {
    func testProjectionMapsPortfolioMetadataAndSplitsCategoryWeightsAcrossTickers() throws {
        ...
        let portfolio = Portfolio(
            ...
            categories: [
                ...
                Category(
                    ...
                    sortOrder: 1,
                    tickers: [
                        Ticker(symbol: " VTI ", currentPrice: Decimal(250), movingAverage: Decimal(245), sortOrder: 2),
                        Ticker(symbol: "VOO", currentPrice: Decimal(500), movingAverage: Decimal(490), sortOrder: 1),
                    ]
                ),
            ]
        )
        ...
        XCTAssertEqual(
            payload.holdings,
            [
                BackendHoldingPayload(portfolioID: portfolioID, ticker: "VOO", weight: Decimal(string: "0.30")!),
                BackendHoldingPayload(portfolioID: portfolioID, ticker: "VTI", weight: Decimal(string: "0.30")!),
                BackendHoldingPayload(portfolioID: portfolioID, ticker: "BND", weight: Decimal(string: "0.40")!),
            ]
        )
    }
    ...
    func testProjectionExcludesLocalOnlyFieldsByConstruction() throws {
        ...
        XCTAssertEqual(payload.holdings, [
    ...
    func testProjectionSkipsZeroWeightEmptyCategory() throws {
        let portfolio = Portfolio(
            ...
            categories: [
                ...
                Category(name: "Investable", weight: 1, sortOrder: 2, tickers: [
